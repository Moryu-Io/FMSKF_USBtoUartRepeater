...
osThreadId USBCtrlTaskHandle;
osThreadId ServoCtrlTaskHandle;
...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(ServoCtrlTask, StartServoCtrlTask, osPriorityHigh, 0, 1024);
  ServoCtrlTaskHandle = osThreadCreate(osThread(ServoCtrlTask), NULL);
...
/* USER CODE BEGIN Header_StartUSBCtrlTask */
/**
* @brief Function implementing the USBCtrlTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartUSBCtrlTask */
void StartUSBCtrlTask(void const * argument)
{
...
/* USER CODE BEGIN Header_StartServoCtrlTask */
/**
* @brief Function implementing the ServoCtrlTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartServoCtrlTask */
void StartServoCtrlTask(void const * argument)
{
